...
module.exports = function(data) {
  ...
  this.setFarm = function(name, size, funits) {
    ...
    if( typeof funits !== 'string' ) throw(new Error('farm units must be a string'));

    try {
      units.ucumParse(units.cleanDollars(funits));
    } catch(e) {
